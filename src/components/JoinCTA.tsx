  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 90 90">
        <path d="M45 0C20.147 0 0 20.147 0 45c0 24.853 20.147 45 45 45s45-20.147 45-45C90 20.147 69.853 0 45 0zm22.5 63c-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm-45 0c-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm6.75-22.5c0-8.284 6.716-15 15-15h1.5c8.284 0 15 6.716 15 15v4.5c0 2.485-2.015 4.5-4.5 4.5h-22.5c-2.485 0-4.5-2.015-4.5-4.5v-4.5z" />
      </svg>
    ),
  },
];
